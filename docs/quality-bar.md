...
| Video recipe | Reproduce a supplied motion language with changed content. | Versioned timeline and runner settings, duration, codec, audio levels, captions, asset provenance. | Review full playback for pacing, continuity, readable text, and audio sync. | External runner contract pending. |
