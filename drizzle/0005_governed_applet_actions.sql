...
CREATE UNIQUE INDEX "applet_run_workspace_applet_id_version_unique" ON "applet_run" USING btree ("workspace_id","applet_id","id","applet_version_id");--> statement-breakpoint
ALTER TABLE "applet_action_request" ADD CONSTRAINT "applet_action_request_run_version_tenant_fk" FOREIGN KEY ("workspace_id","applet_id","run_id","applet_version_id") REFERENCES "public"."applet_run"("workspace_id","applet_id","id","applet_version_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
