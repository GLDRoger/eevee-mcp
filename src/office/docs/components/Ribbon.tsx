...
const COMMAND_LABEL = navigator.platform.toLowerCase().includes('mac') ? '⌘' : 'Ctrl+'
...
// Tab values double as internal state keys and translation lookups.
...
function RibbonInner({
  ...
  const replacePicture = async () => {
    const picked = await desktopApi.pickImage()
    if (!picked) return
            ...
            <div className="file-menu">
              {!sessionMode ? (
                <>
                  ...
                  >
                    {t('ribbonOpen')} <span className="file-menu-key">{COMMAND_LABEL}O</span>
                  </button>
                  <button
                    disabled={!hasDoc}
                    onClick={() => {
                  ...
                  >
                    {t('ribbonSave')} <span className="file-menu-key">{COMMAND_LABEL}S</span>
                  </button>
                  <button
                    disabled={!hasDoc}
                    onClick={() => {
                  ...
                  >
                    {t('ribbonSaveAs')}{' '}
                    <span className="file-menu-key">{COMMAND_LABEL}Shift+S</span>
                  </button>
                </>
              ) : null}
              <button
              ...
              >
                Print <span className="file-menu-key">{COMMAND_LABEL}P</span>
              </button>
              <p className="file-menu-note">Use Print to save a PDF.</p>
            </div>
          )}
        </div>
        {quickActions}
