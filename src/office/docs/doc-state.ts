 ...
 * the extracted action modules.
 */
import type { HeaderFooter, HfPartInfo, ParsedDocFull } from '@/office/engines/docx'
...
export interface PendingNumbering {
  newDefs: Array<{
    numId: string
    kind: 'bullet' | 'ordered'
    levels?: import('@/office/engines/docx').CustomNumberingLevel[]
  }>
  restartNums: Array<{
    numId: string
