/**
 * @/office/engines/pptx-render — high-fidelity pptx render layer (Phase 2).
 *
 ...
 *
 * The Konva adapter that draws this RenderTree lives in web-next's absorbed Slides editor.
 */
export * from './coords'
