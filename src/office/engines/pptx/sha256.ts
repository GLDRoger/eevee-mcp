/**
 * Sync SHA-256 (hex) that matches node:crypto createHash('sha256').digest('hex').
 * Kept sync so PackageArchive.open stays a single async boundary (JSZip), not two.
 */
...
export function sha256Hex(bytes: Uint8Array): string {
  ...
  out.setUint32(20, h5 >>> 0, false)
  out.setUint32(24, h6 >>> 0, false)
  out.setUint32(28, h7 >>> 0, false)
