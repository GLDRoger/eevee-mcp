...
import { applyTableAdd } from './workbook-ops'
...
/// applyFilterCriteria path as the generated op set_filter_criteria.
...
/// generated add_table op (Univer table rendering + journal + native table part).
