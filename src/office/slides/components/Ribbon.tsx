/**
 * Ribbon: tab bar + grouped buttons. Same mechanism as the Documents ribbon
...
import type { ChartStyleInfo } from '@/office/engines/pptx-render'
...
// Draw tab palettes/pen widths (same as Documents DrawTab)
const INK_COLORS = [
  '000000',
  'C00000',
  'FF0000',
...
export function Ribbon({
  ...
  return (
    <div className="ribbon">
      <div className={`ribbon-tabs ${IS_MAC ? 'ribbon-tabs-mac' : 'ribbon-tabs-win'}`}>
        {
