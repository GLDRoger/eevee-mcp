import type { PictureRenderNode, RenderNode, RenderSlide } from '@/office/engines/pptx-render'

/**
 * Freehand ink (Draw tab) — editor-side model. Same mechanism as Documents ink, but a
